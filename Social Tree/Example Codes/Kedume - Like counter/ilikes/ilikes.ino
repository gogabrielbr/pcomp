...
void connectToServer() {
  ...
  if (client.connect(serverName, 80)) {
    ...
    client.println("GET /restserver.php?format=xml&method=fql.multiquery&pretty=0&queries={%22page_info%22%3A%22select%20name%2Cfan_count%2Cpage_url%2Ctype%20from%20page%20where%20page_id%20IN%20(1804701356496677)%22}&sdk=joey HTTP/1.1"); //Gabriel - Added Social Tree page ID
